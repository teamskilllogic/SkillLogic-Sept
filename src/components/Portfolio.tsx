...
// 👇 Array type specify kiya
const projects: Project[] = [
  {
    title: "VARDAAN HOSPITAL",
    description:
      "Designed a responsive website to highlight advanced healthcare services and infrastructure.",
  ...
  },
  {
    ...
    description:
      "Designed and developed a full-featured website for a digital advertising agency.",
  ...
  },
  {
    ...
    description:
      "Created a modern website showcasing construction services and projects.",
  ...
  },
  {
    title: "Ishwar Rugs",
    description:
      "Created an elegant website to display handcrafted rugs and boost customer engagement.",
  ...
  },
  {
    title: "Brantashop",
    description:
      "Developed an e-commerce website to showcase and sell trendy, affordable imitation jewellery collections.",
...
// 👇 Props type specify kiya
const PortfolioCard: React.FC<Project> = ({
  title,
  description,
  tags,
  image,
  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore our recent website design and development projects. From corporate websites to digital agencies, we've done it all."
        />
      ...
      <div className="container-section">
        <div className="text-center mb-16">
          ...
          <p className="animate-on-scroll delay-100 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Explore our recent projects that have helped businesses achieve
            their digital goals.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Button
            asChild
            className="bg-secondary hover:bg-secondary/90 text-white px-8 py-2 text-sm font-medium rounded"
          >
